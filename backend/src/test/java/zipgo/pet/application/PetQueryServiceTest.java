...
class PetQueryServiceTest extends ServiceTest {
    ...
    void 사용자의_반려동물_목록을_조회할_수_있다() {
        ...
        assertAll(
                ...
                () -> assertThat(pets.get(0).getBreed()).isEqualTo(풍산개),
                () -> assertThat(pets.get(0).getBreed().getPetSize()).isEqualTo(소형견)
        );
    }
    ...
    void 견종_정보를_조회할_수_있다() {
        ...
        assertAll(
                ...
                () -> assertThat(찾은_상근이.getBreed().getName()).isEqualTo("풍산개"),
                () -> assertThat(찾은_상근이.getBreed().getPetSize().getName()).isEqualTo("소형견"),
    ...
    class 견종_조회시 {
        ...
        void 첫번째_순서는_항상_믹스견이다() {
            ...
            // when
            List<Breed> 견종_목록 = petQueryService.readBreeds();
